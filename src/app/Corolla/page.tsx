    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center text-3xl font-bold my-12">
                <h1><u>Toyota Corolla 2024 Price In Pakistan, Images, Reviews & Specs</u></h1>
            </div>

            <div className="flex items-center justify-center w-full my-12">
                <img src="/Corolla Details.jfif" alt="Toyota Corolla" />
            </div>
            ...
            <div className="flex items-center justify-center w-full ">
                ...
                <ul>
                    <li><h1  className="text-2xl text-green-600">PKR 60,00,000</h1></li>
                    <li>
                        <a href="/Checkout">
